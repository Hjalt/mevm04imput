\documentclass[headinclude=false]{scrartcl}\usepackage[]{graphicx}\usepackage[]{color}
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-4-4} 
...
\hlstd{support.na} \hlkwb{<-} \hlstd{support[}\hlkwd{is.na}\hlstd{(support}\hlopt{$}\hlstd{totcst), ]} \hlopt{%>%}
 \hlkwd{select}\hlstd{(age, sex, dzgroup, num.co, edu, income, scoma, meanbp, hrt, resp, temp)}
...
\hlkwd{xyplot}\hlstd{(totcst.log} \hlopt{~} \hlstd{charges.log, support.complete,} \hlkwc{panel} \hlstd{=} \hlkwa{function}\hlstd{(}\hlkwc{...}\hlstd{) \{}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{a} \hlkwb{<-} \hlstd{support.complete[}\hlkwd{complete.cases}\hlstd{(support.complete}\hlopt{$}\hlstd{charges),} \hlstr{"totcst.log"}\hlstd{]}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{a} \hlkwb{<-} \hlstd{support.complete[}\hlkwd{complete.cases}\hlstd{(support.complete}\hlopt{$}\hlstd{charges),} \hlstr{"totcst"}\hlstd{]}
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-12-2} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-12-3} 
...
{\centering \includegraphics[width=\maxwidth]{figure/unnamed-chunk-12-4} 
